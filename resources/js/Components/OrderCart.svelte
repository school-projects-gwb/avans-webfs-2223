<script>
    ...
    let cart_data, first_name, last_name, errors = "", orderPlaced = false;
    ...
    function handlePlaceOrder() {
        ...
        axios.post(`/cart/place-order/${is_takeaway ? '1' : '0'}`, requestData, {withCredentials: true})
            .catch(error => {
    ...
    <div>
        ...
        {#if cart_data && cart_data.dish_data.length > 0}
            <div class="relative">
                ...
                <div class="h-72 relative overflow-y-scroll">
                    {#each cart_data.dish_data as dish}
                        <div class="flex flex-col even:bg-gray-100 odd:bg-white p-1">
