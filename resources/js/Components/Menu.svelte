<script>
    export let dish_data, option_data;
</script>

<div class="bg-menu relative overflow-scroll">
    <div class="columns-3 min-w-[1200px] border border-4 border-green-700 m-8 p-4 pointer-events-none select-none">
        {#each Object.entries(dish_data) as [category, category_content]}
